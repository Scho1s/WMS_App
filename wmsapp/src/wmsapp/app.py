...
class WMSApp(toga.App):
    ...
    DEF_LABEL_STYLE = Pack(padding=LABEL_PADDING, font_family=DEF_LABEL_FONT, alignment=RIGHT, width=75)
    ...
    DEF_ERROR_STYLE = Pack(padding=DEF_PADDING, font_size=ERROR_FONT_SIZE, font_family=DEF_ERROR_FONT, alignment=RIGHT, color=RED)
    DEF_SPACER_STYLE = Pack(direction=COLUMN, flex=1)
    ...
    def startup(self):
        ...
        self.main_box = toga.Box(style=Pack(direction=COLUMN,
                                            padding=(10, self.DEF_PADDING, self.DEF_PADDING, self.DEF_PADDING)),
    ...
    def __create_receiving_detail_window(self):
        ...
        self.r_tag_box = toga.Box(style=Pack(padding=self.DEF_PADDING),
        ...
        self.r_lower_menu2_box = toga.Box(style=Pack(padding=self.DEF_PADDING),
    ...
    def r_save_details(self, widget):
        print(self.r_best_before_entry.value)
